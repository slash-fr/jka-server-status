...
// Usage:
// - Run `php jka_server_valid_response.php`
...
do {
    ...
    echo "$peer\n";
    stream_socket_sendto($socket, file_get_contents(__DIR__ . '/sample_response.txt'), 0, $peer);
    // WARNING: be careful when editing "sample_response.txt"
